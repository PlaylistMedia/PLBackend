...
func CreateUser(ctx *fiber.Ctx) error {
	...
	// Set the user's token to the JWT token
	...
	// Checkpoint: The user is now ready to be added to the database.
...
func LoginUser(ctx *fiber.Ctx) error {
	...
	// Hash the password (Request user)best-suited for applications involving big data, machine learning, and editing massive files.18-Nov-2021
	hash, err := HashPassword(user)
